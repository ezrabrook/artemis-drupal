				...
				<div class="inner_frame">
					<div class="row">
						<div class="sub_content_area">
							<div class="col-md-3">
								<div class="side_nav">
									<div class="mobile_sidenav_icon visible-sm visible-xs"><span class="sidenav_left"></span><span class="sidenav_right"></span></div>
									<?php
										/* These if statements allow the appropriate menus to appear on faculty and news content types. *
										* Normally no side menu would be shown as content of these types is not added to the hierarchical menu system. */
										
										$tree = menu_tree_page_data("primary-links");
										foreach($tree as $link_data){
											if($link_data['link']['in_active_trail']){
												if(!empty($link_data['below']))
													print (menu_tree_output($link_data['below']));
											}
										}
									?>
								</div>
							</div>
							<div class="col-md-9 col-sm-12 col-xs-12 sub_right">
