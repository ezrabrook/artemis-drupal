<?php
function open_msupe_form_system_theme_settings_alter(&$form, &$form_state) {
 ...
 $form['background_container']['body_bg_classes'] = array(
  ...
  $form['#submit'][] = 'open_msupe_settings_submit';
  $form['#validate'][] = 'open_msupe_settings_validate';
}

function open_msupe_settings_submit($form, &$form_state) {
  $settings = array();
...
function open_msupe_settings_validate($form, &$form_state) {
