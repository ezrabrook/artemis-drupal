  ...
  <div class="container">
    <div class="row">
      <div class="<?php if ($page['search_box']): print 'span8'; else: print 'span12'; endif; ?>">
        ...
        <?php if ($page['header']): ?>
        <div id="header-content" class="row-fluid header-content"><?php print render($page['header']); ?>
		</div>
        <!-- /#header-content -->
        <?php endif; ?>
      </div>
    ...
    <div class="navbar">
      ...
      <div class="navbar-inner">
        <div class="container">
	      ...
	      <div id="nav-search" class="nav-search search-query visible-desktop"> <?php print render($page['search_box']); ?> </div>
	      <?php endif; ?>
	      <?php if ($page['search_box']): ?>
	      <div id="navbar-search" class="navbar-search search-query hidden-desktop"> <?php print render($page['search_box']); ?> </div>
	      <?php endif; ?>
...
<div id="main" class="clearfix main" role="main">
  <div class="container">
	<?php if (!$is_front):?><?php if ($breadcrumb): ?>
